...
install:
	...
	7z x -o$(DESTDIR)/opt/hashstack/programs/ oclHashcat-1.36.7z
	mv $(DESTDIR)/opt/hashstack/programs/oclHashcat-1.36 $(DESTDIR)/opt/hashstack/programs/oclHashcat
	cd $(DESTDIR)/opt/hashstack/programs/oclHashcat && \
		printf "\x88\x00\x00\x00" >eula.accepted && \
